...
const JOBS: JobSeed[] = [
  // ---- NorCal ----
  {
    ...
    product: "SYSTEM", stage: "SCHEDULED",
  ...
  },
  {
    ...
    product: "SYSTEM", stage: "CONFIRMED",
  ...
  },
  {
    ...
    product: "SYSTEM", stage: "IN_PROGRESS",
